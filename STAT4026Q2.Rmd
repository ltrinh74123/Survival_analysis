...
library("survival")
library("survminer")
data = readxl::read_xlsx("/Users/betty/Desktop/240508_Survival_project_for_maths_students_opened.xlsx")
```
...
df <- data %>% select(-'PID', -'Diagnosis_number', -'SummaryPrimaryDiagnosis_descriptor', -'Sex (Male 1, Female 2)', -'CBI::PercentBeliefsFCorrected')
#Standarize data
...
data_stand <- cbind(data_standardized, data$Diagnosis_number, data$`Sex (Male 1, Female 2)`, data$`CBI::PercentBeliefsFCorrected`)
