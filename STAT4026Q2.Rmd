...
df <- data %>% select(-'PID', -'Diagnosis_number', -'SummaryPrimaryDiagnosis_descriptor', -'Sex (Male 1, Female 2)', -'CBI::PercentBeliefsFCorrected', -'CBI::PercentSleepFCorrected')
#Standarize data
...
m2 <- coxph(
  Surv(`Diagnosis till death`) ~ . + strata(`Sex (Male 1, Female 2)`) + strata(`CBI::PercentSleepFCorrected`), 
